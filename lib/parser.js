...
// parser /bin/wcc 和 /bin/wcsc 是 微信官方的
// package.json 的
// "wxml-transpiler": "^1.0.5"
// "wxss-transpiler": "^1.0.4"
// 是 weidian inc 自己的 parser
// 官方的 wcsc parser 转 CSS3 雷达动画 会有问题
const useDefaultCompiler_WXML = process.env.DFT_CMP_WXML === 'true'
const useDefaultCompiler_WCSS = process.env.DFT_CMP_WCSS === 'true'
