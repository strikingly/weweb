...
var apiObj = {
  ...
  _appendH5TeamMemberIdForRequest: function _appendH5TeamMemberIdForRequest(originalUrl) {
    ...
    var teamMemberId = localStorage.getItem('teamMemberId') || 'missing_team_member_id';
  ...
  getUserInfo: function getUserInfo(params) {
    var apiHost = localStorage.getItem('apiHost') || 'https://www.preprod.sxl.cn';
    var teamMemberId = localStorage.getItem('teamMemberId');
