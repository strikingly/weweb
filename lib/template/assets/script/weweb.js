...
exports.transition = __webpack_require__(180)

exports.transform = transform

exports.touchAction = __webpack_require__(181)

exports.has3d = __webpack_require__(182)
...
var _mask = __webpack_require__(178);
...
var clone = __webpack_require__(201);
var type = __webpack_require__(46);
var ease = __webpack_require__(202);
...
var _autoscaleCanvas = __webpack_require__(184);
...
var _mask = __webpack_require__(191);
...
var _proxyRequirst = __webpack_require__(139);

var _proxyRequirst2 = _interopRequireDefault(_proxyRequirst);

var _command = __webpack_require__(140);
...
var invoke = function invoke(eventName, params, callback) {
  ...
  if (userApi.hasOwnProperty(eventName)) {
    ...
    if (_proxyRequirst2.default[eventName]) {
      ...
      var callbackId = ++callbackIndex;callbacks[callbackId] = callback, callSystemCmd(eventName, params, callbackId); // eventName->sdkName
    }
  } else if (!showWarning) {
    showWarning = true;
...
var request = function request(event, params, callback) {
  ...
  if (__wxConfig__ && __wxConfig__.weweb && (__wxConfig__.weweb.requestProxy || __wxConfig__.weweb.requestType == 'ajax')) {
    ...
    if (__wxConfig__.weweb.requestType != 'ajax') {
      ...
      requestObj.setRequestHeader('Cache-Control', 'no-cache, no-store, must-revalidate');
    ...
    method != 'POST' || typeTag || requestObj.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
...
var _filePicker = __webpack_require__(144);

var _filePicker2 = _interopRequireDefault(_filePicker);

var _upload = __webpack_require__(146);
...
var _tabbar = __webpack_require__(192);

var _tabbar2 = _interopRequireDefault(_tabbar);

var _throttleit = __webpack_require__(193);

var _throttleit2 = _interopRequireDefault(_throttleit);

var _record = __webpack_require__(194);

var _record2 = _interopRequireDefault(_record);

var _compass = __webpack_require__(198);
...
var _timePicker = __webpack_require__(203);
...
var _fileList = __webpack_require__(205);
...
var _actionsheet = __webpack_require__(211);
...
function publish(data) {
  ...
  _index2.default.eachView(function (view) {
    if (ids.indexOf(view.id) !== -1) {
      var newObj = JSON.parse((0, _stringify2.default)(obj));
      newObj.ext = { path: view.path };
      view.postMessage(JSON.parse((0, _stringify2.default)(newObj)));
    }
  });
}
...
var event = __webpack_require__(145);
...
var trim = __webpack_require__(162);
var type = __webpack_require__(46);
...
var View = function (_Emitter) {
  ...
  (0, _createClass3.default)(View, [{
    ...
    key: 'createPage',
    value: function createPage(id, hidden, parent) {
      if (!parent) {
...
var prop = __webpack_require__(183);
...
var _actionsheet = __webpack_require__(186);
...
var header = {
  ...
  setState: function setState(data) {
    ...
    this.dom.headHomeI.className = state.color == 'white' ? 'weweb-head-home-icon white' : 'weweb-head-home-icon';
...
var hasTouch = __webpack_require__(189)
...
var _Recorder = __webpack_require__(196);
...
var _inlineWorker = __webpack_require__(197);
...
var request = __webpack_require__(207);
...
var _radioComponent = __webpack_require__(213);
...
var _pinchZoom = __webpack_require__(214);
...
var Pinch = __webpack_require__(216)
...
var API_HOST = localStorage.getItem('apiHost') || 'https://www.preprod.sxl.cn';
var DEFAULT_EXTCONFIG = {
  "attr": {
    "contactItems": [{
      "showInMp": true,
      "labelname": "网站",
...
var apiObj = {
  ...
  _appendH5TeamMemberIdForRequest: function _appendH5TeamMemberIdForRequest(originalUrl) {
    if (!originalUrl) {
      return '';
    }
    ...
    var teamMemberId = wx.getStorageSync('teamMemberId') || 'missing_team_member_id_from_H5';
    var h5TeamMemberIdParam = separator + 'h5TeamMemberId=' + teamMemberId;
  ...
  getUserInfo: function getUserInfo(params) {
    var teamMemberId = wx.getStorageSync('teamMemberId');
    ...
    var cachedUserInfo = sessionStorage.getItem(teamMemberId);
    if (cachedUserInfo) {
    ...
    wx.request({
      ...
      success: function success(res) {
        if (res.data && res.data.data && res.data.data.userInfo) {
          ...
          sessionStorage.setItem(teamMemberId, (0, _stringify2.default)(userInfo));
  ...
  makePhoneCall: function makePhoneCall(params) {
  ...
  (0, _createClass3.default)(PageParser, [{
    ...
    value: function setData(dataObj, callback) {
      try {
        ...
        this.data = Object.expand((0, _assign2.default)({}, this.data, dataObj));
      } catch (e) {
...
var createBodyNode = function createBodyNode(data) {
  ...
  if (window.__curPage__.path == data['ext-path'] || data['ext-path'] == null) {
    ...
    for (var i in window.__views) {
      if (window.__views[i].path && window.__views[i].path == data['ext-path']) {
        view = window.__views[i];
      }
    }
    var _root = view.__generateFunc__(view.envData, // AppData.getAppData(),
    data.data);
    // t.tag = "body"
    return createWXVirtualNodeRec(_root);
  }
};
...
var reRender = function reRender(event) {
  var newBodyNode = createBodyNode(event);
  ...
  if (window.__curPage__.path == event['ext-path']) {
    ...
    var view = null;
    for (var i in window.__views) {
      if (window.__views[i].path && window.__views[i].path == event['ext-path']) {
        view = window.__views[i];
      }
    }

    var _patch = view.rootNode.diff(newBodyNode);
    _patch.apply(view.__DOMTree__);
    view.rootNode = newBodyNode;
  }
};

var renderOnDataChange = function renderOnDataChange(event) {
  var path = event['ext-path'];
...
var blackList = ["info-content", "analytics"];

var rejectDirtyPatch = function rejectDirtyPatch(vpatch) {
  if (vpatch && vpatch.patch && vpatch.patch.props && vpatch.patch.props.class) {
    var className = vpatch.patch.props.class;
    var isDirty = blackList.some(function (b) {
      return className.includes(b);
    });
    return isDirty;
  }
};
